...
<div class="post-item-main">
    <div class="post-item-opacity d-flex justify-content-center align-items-center">
        <form action="{{ url("posts/{$post_item->id}") }}" method="POST">
            @csrf
            @method('PUT')
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 offset-md-4">
                        <input type="text"
                               id="post-item-title"
                               value="{{ old('post_title') ?? $post_item->title }}"
                               class="post-item-input"
                               name="post_title"
                        />
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 offset-md-4">
                        <textarea id="post-item-content"
                                  class="post-item-input post-item-content"
                                  name="post_content">{{ old('post_content') ?? $post_item->content }}
                        </textarea>
                        <small class="text-danger">
                            @error('post_content'){{$message}}@enderror
                        </small>
                    </div>
                </div>
