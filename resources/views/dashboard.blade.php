    ...
    <div class="pt-5 pb-2">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="ps-6 bg-white border-b border-gray-200">
                    <form action="/my-posts/{{ $userId }}" method="GET">
                        @csrf
                        <button type="submit">
                            <h3 class="show-my-posts px-2">Show all my posts</h3>
                        </button>
                    </form>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="ps-6 bg-white border-b border-gray-200">
                    <form action="/posts/create" method="GET">
                        @csrf
                        <button type="submit">
                            <h3 class="show-my-posts px-2">Add new post</h3>
                        </button>
                    </form>
                </div>
            </div>
                        ...
                        <div class="row g-0">
                            <div class="col-md-2">
                                @if($post->user->avatar_path !== '')
                                    <img src="{{ $post->user->avatar_path }}" class="img-fluid rounded-start" alt="...">
                                @else
